...
class LocalException extends \Exception
{
     ...
     * @param array $parameters Parámetros del mensaje de la excepción.
    ...
    function __construct($codigo, $parameters = null, $interna = null, $locale = null)
    {
        ...
        if (is_array($parameters)) {
            $this->mensaje = call_user_func_array("sprintf",array_merge(array($parametrosExcepcion['mensaje']),$parameters));
        } else {
        ...
        try {
            ...
            if (array_key_exists('mensaje', $parametrosExcepcion)) {
                ...
                if (is_array($parameters)) {
                    $this->mensaje = call_user_func_array("sprintf",array_merge(array($this->mensaje),$parameters));
                }
                $this->message = $this->mensaje;
            }
            if (array_key_exists('descripcion', $parametrosExcepcion)) {
